...
class _AllToAll(torch.autograd.Function):
    @staticmethod
    def forward(ctx, group, input, output_split_sizes, input_split_sizes, forward_output, backward_output):
        """Forward function."""
        ctx.group = group
        ctx.output_split_sizes = output_split_sizes
        ctx.input_split_sizes = input_split_sizes
        ctx.backward_output = backward_output
    ...
    def backward(ctx, *grad_output):
        ...
        return (
            None,
            _AllToAll.apply(ctx.group, *grad_output, ctx.input_split_sizes, ctx.output_split_sizes, None, ctx.backward_output),
            None,
            None,
            None,
            None,
...
def all_to_all(group, input_, output_split_sizes_=None, input_split_sizes=None, forward_output=None, backward_output=None):
    """Wrapper for autograd function"""
    return _AllToAll.apply(group, input_, output_split_sizes_, input_split_sizes, forward_output, backward_output)
